/**
 * Cryptographic helpers for Midnight ScholarShield ZK Circuit Emulation & Prover
 */
...
/**
 * Computes Student Identity Commitment = Hash(studentSecret + salt)
 */
...
/**
 * Computes Application Nullifier = Hash(studentSecret + scholarshipId)
 * Ensures 1 application per student per scholarship without leaking identity
 */
...
/**
 * Merkle Tree for University Student Whitelist Membership Proofs
 */
